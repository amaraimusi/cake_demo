...
<!-- 一覧テーブル -->
<table id="user_mng_tbl" border="1"  class="table_transform">
...
foreach($data as $i=>$ent){
	...
	$this->FrontA->tdStr($ent,'username');
	$this->FrontA->tdStr($ent,'password');
	$this->FrontA->tdPlain($ent,'role');
