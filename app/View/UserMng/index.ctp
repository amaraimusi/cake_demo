...
$jsList[] = 'UserMng/index.js' . $ver_str; // 当画面専用JavaScript
...
<div class="cb_func_line">
	...
	<form action="" class="form_kjs" id="user_mngIndexForm" method="post" accept-charset="utf-8">
		...
		$this->CrudBase->inputKjText('kj_update_user','更新ユーザー');
		$this->CrudBase->inputKjText('kj_ip_addr','更新IPアドレス');
...
<!-- 一覧テーブル -->
<table id="user_mng_tbl" class="table table-striped table-bordered " style="display:none;margin-bottom:0px">
